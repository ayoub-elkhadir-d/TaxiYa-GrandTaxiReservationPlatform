            ...
            <div class="md:col-span-1 hidden md:block">
                <div class="bg-white rounded-xl p-6 shadow-sm sticky top-32">
                    ...
                    <div class="mb-6">
                        ...
                        <label class="flex items-center gap-2 mb-2"><input type="checkbox" class="rounded text-primary">
                            <span class="text-sm">Morning</span></label>
                        <label class="flex items-center gap-2"><input type="checkbox" class="rounded text-primary">
                            <span class="text-sm">Afternoon</span></label>
                    </div>
                </div>
            </div>
